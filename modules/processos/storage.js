import { HISTORY_STORAGE_KEY, SNAPSHOT_STORAGE_KEY, UI_STATE_STORAGE_KEY } from "./constants";
...
export function loadOperationalSnapshot() {
  return readJsonStorage(SNAPSHOT_STORAGE_KEY, null);
}

export function persistOperationalSnapshot(snapshot) {
  writeJsonStorage(SNAPSHOT_STORAGE_KEY, snapshot || {});
}

export function currentHashValue() {
  if (typeof window === "undefined") return "";
