...
export const ADVOGADO_MODULES = {
  ...
  partes: {
    title: 'Partes',
    singular: 'parte',
    description: 'Gestão de pessoas físicas, jurídicas, credores e devedores vinculados aos processos.',
    primaryField: 'nome',
    status: ['ativo', 'em_validacao', 'vinculada', 'inativa', 'arquivada'],
    fields: [
      { key: 'nome', label: 'Nome da parte', type: 'text', required: true },
      { key: 'tipo_pessoa', label: 'Tipo de pessoa', type: 'select', options: ['fisica', 'juridica'], required: true },
      { key: 'cpf_cnpj', label: 'CPF/CNPJ', type: 'text', required: true },
      { key: 'classificacao', label: 'Classificação', type: 'select', options: ['credor', 'devedor', 'parte_processual', 'representante'], required: true },
      { key: 'contato', label: 'Contato', type: 'text' },
      { key: 'processo_ref', label: 'Processo relacionado', type: 'text' },
      { key: 'plano_ref', label: 'Plano relacionado', type: 'text' },
      { key: 'cliente', label: 'Cliente vinculado', type: 'text' },
