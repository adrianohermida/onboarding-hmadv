...
export const STEP_STATE_META = {
  locked:          { label: 'Bloqueado',    color: '#94a3b8', bg: '#f1f5f9', icon: '🔒' },
  available:       { label: 'Disponível',   color: '#2E6DA4', bg: '#eff6ff', icon: '▶' },
  in_progress:     { label: 'Em andamento', color: '#c07b00', bg: '#fffbeb', icon: '⏳' },
  awaiting_review: { label: 'Em análise',   color: '#c07b00', bg: '#fffbeb', icon: '🔍' },
  approved:        { label: 'Aprovado',     color: '#16a34a', bg: '#f0fdf4', icon: '✓' },
  rejected:        { label: 'Devolvido',    color: '#dc2626', bg: '#fef2f2', icon: '✗' },
