...
- Acessibilidade WCAG AA`}}}},r={args:{variant:"primary",children:"Confirmar Ação"}},s={args:{variant:"secondary",children:"Cancelar"}},e={args:{variant:"outline",children:"Ver Detalhes"}},t={args:{variant:"ghost",children:"Ignorar"}},o={args:{variant:"danger",children:"Excluir"}},n={render:()=>`
  ...
  `},a={args:{block:!0,children:"Botão Full Width"}},i={args:{loading:!0,children:"Salvando..."}},d={args:{disabled:!0,children:"Não clicável"}},c={args:{icon:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>',children:"Continuar"}},l={render:()=>`
...
Ações secundárias`,...s.parameters?.docs?.description}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    variant: 'outline',
...
Sem borda ou fundo (hover apenas)`,...t.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    variant: 'danger',
    children: 'Excluir'
  }
}`,...o.parameters?.docs?.source},description:{story:`### Danger\r
Ações destrutivas`,...o.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => \`
    <div style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
      <button class="ds-btn ds-btn-primary ds-btn-sm">Small (32px)</button>
      <button class="ds-btn ds-btn-primary ds-btn-md">Medium (40px)</button>
  ...
  \`
}`,...n.parameters?.docs?.source},description:{story:`### Tamanhos\r
Comparativo de tamanhos`,...n.parameters?.docs?.description}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    block: true,
    children: 'Botão Full Width'
  }
}`,...a.parameters?.docs?.source},description:{story:`### Block Mobile\r
Largura total em mobile`,...a.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    loading: true,
    children: 'Salvando...'
  }
...
Empilhado em telas pequenas`,...b.parameters?.docs?.description}}};const g=["Primary","Secondary","Outline","Ghost","Danger","Sizes","BlockMobile","Loading","Disabled","WithIcon","IconOnly","ButtonGroup","MobileStacked"];export{a as BlockMobile,p as ButtonGroup,o as Danger,d as Disabled,t as Ghost,l as IconOnly,i as Loading,b as MobileStacked,e as Outline,r as Primary,s as Secondary,n as Sizes,c as WithIcon,g as __namedExportsOrder,m as default};
