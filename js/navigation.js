...
export const PORTAL_MODULES = [
  ...
  { key: 'financial-dashboard', title: 'Diagnostico Financeiro', menuLabel: 'Financas', parent: 'Meu Plano', order: 520, visible: true, roles: ['cliente'], feature: 'financialDashboard', icon: 'chart-column', sidebarSection: 'jornada', sidebarSectionLabel: 'Jornada e suporte', sidebarSectionOrder: 20 },
  ...
  { key: 'onboarding', title: 'Formulario', menuLabel: 'Formulario', parent: 'Meu Caso', order: 540, visible: true, roles: ['cliente'], feature: 'onboardingLegacy', icon: 'clipboard-list', sidebarSection: 'jornada', sidebarSectionLabel: 'Jornada e suporte', sidebarSectionOrder: 20 },
