...
export const PORTAL_MODULES = [
  ...
  { key: 'audiencias', title: 'Audiencias', menuLabel: 'Audiencias', parent: 'Painel', order: 70, visible: true, roles: ['admin'], feature: 'audiencias', icon: 'gavel', sidebarSection: 'operacao', sidebarSectionLabel: 'Operacao diaria', sidebarSectionOrder: 10 },
  ...
  { key: 'tarefas', title: 'Tarefas', menuLabel: 'Tarefas', parent: 'Painel', order: 90, visible: true, roles: ['admin'], feature: 'tarefas', icon: 'check-square', sidebarSection: 'operacao', sidebarSectionLabel: 'Operacao diaria', sidebarSectionOrder: 10 },
  { key: 'agenda', title: 'Agenda', menuLabel: 'Agenda', parent: 'Painel', order: 100, visible: true, roles: ['admin'], feature: 'agenda', icon: 'calendar-days', sidebarSection: 'operacao', sidebarSectionLabel: 'Operacao diaria', sidebarSectionOrder: 10 },
  ...
  { key: 'financeiro', title: 'Financeiro', menuLabel: 'Financeiro', parent: 'Painel', order: 110, visible: true, roles: ['admin'], feature: 'financeiro', icon: 'wallet', sidebarSection: 'operacao', sidebarSectionLabel: 'Operacao diaria', sidebarSectionOrder: 10 },
