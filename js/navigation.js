...
export const PORTAL_MODULES = [
  ...
  { key: 'movimentacoes',       title: 'Movimentações',         menuLabel: 'Movimentações',       parent: 'Painel', order: 340, visible: true,  roles: ['admin'], feature: 'movimentacoes',       icon: 'history',       adminSidebarSection: 'operacoes', adminSidebarSectionLabel: 'Operações', adminSidebarSectionOrder: 20 },
  { key: 'relacoes-processuais',title: 'Relações Processuais',  menuLabel: 'Relações Processuais',parent: 'Painel', order: 350, visible: true,  roles: ['admin'], feature: 'relacoesProcessuais', icon: 'git-merge',     adminSidebarSection: 'operacoes', adminSidebarSectionLabel: 'Operações', adminSidebarSectionOrder: 20 },
  { key: 'tpu',                 title: 'TPU',                   menuLabel: 'TPU',                 parent: 'Painel', order: 360, visible: true,  roles: ['admin'], feature: 'tpu',                 icon: 'network',       adminSidebarSection: 'operacoes', adminSidebarSectionLabel: 'Operações', adminSidebarSectionOrder: 20 },
  { key: 'orgaos-judiciarios',  title: 'Órgãos Judiciários',    menuLabel: 'Órgãos Judiciários',  parent: 'Painel', order: 370, visible: true,  roles: ['admin'], feature: 'orgaosJudiciarios',   icon: 'building-2',    adminSidebarSection: 'cadastros',  adminSidebarSectionLabel: 'Cadastros',  adminSidebarSectionOrder: 45 },
  { key: 'serventias',          title: 'Serventias',            menuLabel: 'Serventias',          parent: 'Painel', order: 380, visible: true,  roles: ['admin'], feature: 'serventias',          icon: 'land-plot',     adminSidebarSection: 'cadastros',  adminSidebarSectionLabel: 'Cadastros',  adminSidebarSectionOrder: 45 },
